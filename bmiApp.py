...
st.write(" 45 กม. 162 ซม.")

#ส่วนที่ 2 สร้างช่องรับค่าน้ำหนัก และ ส่วนสูง
weight = st.number_input(" 45 (กิโลกรัม) :", min_value=1.0)
height_cm = st.number_input("162 (เซนติเมตร):",min_value=1.0)

#ส่วนที่ - สร้างปุ่มกดคำนวณ
if st.button("คำนวณ BMI 📝 "):
  #แปลงส่วนสูง จาก cm เป็น เมตร แล้วคำนวณ BMI
...
#ส่วนที่ 4 แปลผลค่า BMI ตามเเกณฑ์
  if bmi < 18.5:
...
st.divider()
st.write("นางสาวญาณิศา ทอสาร เลขที่ 14 ม.4/15") 
